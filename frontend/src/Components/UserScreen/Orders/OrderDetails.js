      ...
      <View style={styles.reviewSection}>
        <View style={styles.reviewHeader}>
          ...
          {userReview ? (
            ...
            >
              <Icon name="edit" size={16} color="#1f5ea6" />
          ...
          >
            ...
            <View style={styles.header}>
              ...
              <View style={styles.statusBadge}>
                <View style={[styles.statusDot, { backgroundColor: STATUS_COLORS[order.orderStatus] || '#8da9c4' }]} />
                <Text style={[styles.statusText, { color: STATUS_COLORS[order.orderStatus] || '#8da9c4' }]}>
                  {order.orderStatus}
                </Text>
              </View>
            </View>
            ...
            {order.orderStatus === 'Cancelled' && (
              <View style={styles.cancelledContainer}>
                <Icon name="cancel" size={24} color="#1f5ea6" />
            ...
            <View style={styles.section}>
              ...
              <View style={styles.infoRow}>
                <Icon name="location-on" size={18} color="#9ab4d3" />
              ...
              <View style={styles.infoRow}>
                <Icon name="phone" size={18} color="#9ab4d3" />
            ...
            <View style={styles.section}>
              ...
              <View style={styles.infoRow}>
                <Icon name="payment" size={18} color="#9ab4d3" />
                <Text style={styles.infoText}>
              ...
              <View style={styles.infoRow}>
                <Icon name="receipt" size={18} color="#9ab4d3" />
                <Text style={styles.infoText}>
              ...
              {order.paidAt && (
                <View style={styles.infoRow}>
                  <Icon name="event" size={18} color="#9ab4d3" />
                  <Text style={styles.infoText}>
            ...
            <View style={styles.section}>
              ...
              <View style={styles.dateRow}>
                <Icon name="event" size={16} color="#8da9c4" />
              ...
              {order.deliveredAt && (
                <View style={styles.dateRow}>
                  <Icon name="check-circle" size={16} color="#8da9c4" />
