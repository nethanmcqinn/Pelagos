...
const Profile = ({ navigation }) => {
  ...
  const getProviderIcon = () => {
    switch (user?.authProvider) {
      ...
      default:
        return <Ionicons name="mail" size={16} color={PROFILE_COLORS.mutedText} />;
    }
  };
    ...
    return (
      <UserDrawer>
        <View style={styles.loadingContainer}>
          <ActivityIndicator size="large" color={PROFILE_COLORS.accent} />
        </View>
      </UserDrawer>
    );
  }
    ...
    <UserDrawer>
      ...
      >
        ...
        <View style={styles.header}>
          ...
          >
            <Ionicons name="create-outline" size={20} color={PROFILE_COLORS.accentSoft} />
        ...
        <View style={styles.infoSection}>
          ...
          <View style={styles.infoCard}>
            <View style={styles.infoRow}>
              <Ionicons name="mail-outline" size={20} color={PROFILE_COLORS.accent} />
              <Text style={styles.infoLabel}>Email</Text>
              <Text style={styles.infoValue}>{user?.email || '-'}</Text>
            </View>
            
            <View style={styles.infoRow}>
              <Ionicons name="call-outline" size={20} color={PROFILE_COLORS.accent} />
        ...
        <View style={styles.infoSection}>
          ...
          <View style={styles.infoCard}>
            <View style={styles.infoRow}>
              <Ionicons name="location-outline" size={20} color={PROFILE_COLORS.accent} />
              <Text style={styles.infoLabel}>City</Text>
              <Text style={styles.infoValue}>{user?.address?.city || 'Not provided'}</Text>
            </View>
            
            <View style={styles.infoRow}>
              <Ionicons name="map-outline" size={20} color={PROFILE_COLORS.accent} />
              <Text style={styles.infoLabel}>Barangay</Text>
              <Text style={styles.infoValue}>{user?.address?.barangay || 'Not provided'}</Text>
            </View>
            
            <View style={styles.infoRow}>
              <Ionicons name="home-outline" size={20} color={PROFILE_COLORS.accent} />
              <Text style={styles.infoLabel}>Street</Text>
              <Text style={styles.infoValue}>{user?.address?.street || 'Not provided'}</Text>
            </View>
            
            <View style={styles.infoRow}>
              <Ionicons name="mail-unread-outline" size={20} color={PROFILE_COLORS.accent} />
            ...
            <View style={styles.modalContent}>
              <View style={styles.modalHeader}>
                ...
                <TouchableOpacity onPress={() => setEditModalVisible(false)}>
                  <Ionicons name="close" size={24} color={PROFILE_COLORS.mutedText} />
                </TouchableOpacity>
              </View>
...
const styles = StyleSheet.create({
  ...
  header: {
    backgroundColor: PROFILE_COLORS.panel,
    alignItems: 'center',
    paddingVertical: 30,
  ...
  avatarUploading: {
    justifyContent: 'center',
    alignItems: 'center',
    backgroundColor: PROFILE_COLORS.panelAlt,
  },
  avatarPlaceholder: {
    width: 100,
    height: 100,
    ...
    alignItems: 'center',
    borderWidth: 3,
    borderColor: PROFILE_COLORS.panel,
  },
  ...
  editProfileText: {
    fontSize: 14,
    color: PROFILE_COLORS.accentSoft,
    fontWeight: '600',
  },
  infoSection: {
    marginTop: 20,
