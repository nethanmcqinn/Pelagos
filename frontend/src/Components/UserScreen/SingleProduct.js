  ...
  if (!validImages || urls.length === 0) {
    return (
      <View style={styles.noImageBox}>
        <Icon name="set-meal" size={64} color={PRODUCT_COLORS.mutedText} />
          ...
          {[1, 2, 3, 4, 5].map((i) => (
            <TouchableOpacity key={i} onPress={() => onRate && onRate(i)}>
              <Icon
                ...
                size={size}
                color={i <= rating ? '#FFD700' : PRODUCT_COLORS.mutedText}
              />
            </TouchableOpacity>
          ))}
        </View>
      ...
      return (
        <View style={styles.starsRow}>
          ...
          {[...Array(emptyStars)].map((_, i) => (
            <Icon key={`empty-${i}`} name="star-border" size={size} color={PRODUCT_COLORS.mutedText} />
          ))}
        </View>
      );
    }
...
export default function SingleProduct({ route, navigation }) {
    ...
    return (
      <UserDrawer>
        <View style={styles.centered}>
          <ActivityIndicator size="large" color="#1f5ea6" />
  ...
  if (!product) {
    return (
      <UserDrawer>
        <View style={styles.centered}>
          <Icon name="search-off" size={64} color={PRODUCT_COLORS.mutedText} />
            ...
            <View style={styles.detailsCard}>
              <View style={styles.chipRow}>
                <View style={styles.categoryChip}>
                  <Icon name="category" size={13} color="#1f5ea6" />
              ...
              {product.isOnSale && product.discountStartDate && product.discountEndDate && (
                <View style={styles.discountPeriodContainer}>
                  <Icon name="event" size={16} color={PRODUCT_COLORS.warning} />
              ...
              {loadingReviews ? (
                <View style={styles.reviewsLoader}>
                  <ActivityIndicator size="small" color="#1f5ea6" />
                ...
                <>
                  ...
                  {product.brand && (
                    <View style={styles.infoRow}>
                      <Icon name="storefront" size={18} color="#1f5ea6" />
                  ...
                  {product.weight && (
                    <View style={styles.infoRow}>
                      <Icon name="fitness-center" size={18} color="#1f5ea6" />
              ...
              >
                <View style={styles.reviewModalHeader}>
                  ...
                  <TouchableOpacity onPress={() => {
                    ...
                    <Icon name="close" size={24} color="#e6f0ff" />
                  </TouchableOpacity>
                </View>
                  ...
                  <View style={styles.reviewProductImageContainer}>
                    {product.images && product.images.length > 0 ? (
                      ...
                      <View style={styles.reviewProductImagePlaceholder}>
                        <Icon name="image" size={24} color={PRODUCT_COLORS.mutedText} />
                      </View>
                    )}
                  </View>
        ...
        <View style={styles.bottomBar}>
          ...
          >
            {cartLoading ? (
              ...
              <>
                <Icon name="add-shopping-cart" size={22} color="#1f5ea6" />
...
const styles = StyleSheet.create({
  safeArea: { flex: 1, backgroundColor: PRODUCT_COLORS.background },
  centered: { flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: PRODUCT_COLORS.background, gap: 12 },
  loadingText: { fontSize: 15, color: PRODUCT_COLORS.mutedText, marginTop: 8 },
  notFoundText: { fontSize: 18, fontWeight: 'bold', color: PRODUCT_COLORS.mutedText, marginTop: 12 },
  backBtn: { marginTop: 16, paddingHorizontal: 24, paddingVertical: 10, backgroundColor: PRODUCT_COLORS.accent, borderRadius: 25 },
  ...
  carouselContainer: { backgroundColor: PRODUCT_COLORS.panel },
  mainImage: { width: SCREEN_WIDTH, height: IMAGE_HEIGHT },
  noImageBox: { width: SCREEN_WIDTH, height: IMAGE_HEIGHT, backgroundColor: PRODUCT_COLORS.border, justifyContent: 'center', alignItems: 'center' },
  noImageText: { color: PRODUCT_COLORS.mutedText, fontSize: 14, marginTop: 8 },
  imageCounter: {
  ...
  dotActive: { backgroundColor: PRODUCT_COLORS.accent, width: 10, height: 10 },
  thumbnailStrip: { backgroundColor: PRODUCT_COLORS.panel, borderTopWidth: 1, borderTopColor: PRODUCT_COLORS.border },
  ...
  thumbnailActive: { borderColor: PRODUCT_COLORS.accent },
  detailsCard: {
    backgroundColor: PRODUCT_COLORS.panel, borderTopLeftRadius: 20, borderTopRightRadius: 20,
  ...
  categoryChip: { flexDirection: 'row', alignItems: 'center', backgroundColor: PRODUCT_COLORS.panelAlt, paddingHorizontal: 10, paddingVertical: 4, borderRadius: 20, borderWidth: 1, borderColor: PRODUCT_COLORS.border },
  categoryChipText: { fontSize: 12, color: PRODUCT_COLORS.accentSoft, fontWeight: '600', marginLeft: 4 },
  discountBadge: {
    backgroundColor: PRODUCT_COLORS.accent,
    paddingHorizontal: 8,
    paddingVertical: 4,
    borderRadius: 20,
  },
  ...
  productName: { fontSize: 22, fontWeight: '800', color: PRODUCT_COLORS.text, marginBottom: 12, lineHeight: 30 },
  priceContainer: {
    flexDirection: 'row',
    alignItems: 'center',
    flexWrap: 'wrap',
  ...
  productPrice: { fontSize: 28, fontWeight: '900', color: PRODUCT_COLORS.accentSoft },
  originalPrice: {
    fontSize: 18,
    color: PRODUCT_COLORS.mutedText,
  ...
  discountPeriodContainer: {
    flexDirection: 'row',
    alignItems: 'center',
    backgroundColor: PRODUCT_COLORS.panelAlt,
    padding: 10,
    borderRadius: 8,
    marginBottom: 12,
    borderWidth: 1,
  ...
  viewAllReviewsText: {
    fontSize: 12,
    color: PRODUCT_COLORS.accentSoft,
    fontWeight: '600',
  },
  ...
  userReviewItem: {
    backgroundColor: PRODUCT_COLORS.panelAlt,
    borderColor: PRODUCT_COLORS.accent,
    borderWidth: 1.5,
  },
  reviewHeader: {
    flexDirection: 'row',
  ...
  reviewModalContent: {
    backgroundColor: PRODUCT_COLORS.panel,
  ...
  reviewProductImagePlaceholder: {
    ...
    justifyContent: 'center',
    alignItems: 'center',
    backgroundColor: PRODUCT_COLORS.border,
  },
  reviewProductName: {
    flex: 1,
    fontSize: 14,
  ...
  divider: { height: 1, backgroundColor: PRODUCT_COLORS.border, marginVertical: 16 },
  sectionTitle: { fontSize: 16, fontWeight: '700', color: PRODUCT_COLORS.text, marginBottom: 8 },
  descriptionText: { fontSize: 15, color: PRODUCT_COLORS.mutedText, lineHeight: 24 },
  infoRow: { flexDirection: 'row', alignItems: 'center', paddingVertical: 6 },
  infoLabel: { fontSize: 14, color: PRODUCT_COLORS.mutedText, flex: 0.3, marginLeft: 8 },
  infoValue: { fontSize: 14, color: '#e6f0ff', fontWeight: '600', flex: 0.7 },
  bottomBar: {
    flexDirection: 'row', paddingHorizontal: 16, paddingVertical: 14, paddingBottom: 20,
    backgroundColor: PRODUCT_COLORS.panel, borderTopWidth: 1, borderTopColor: PRODUCT_COLORS.border,
    elevation: 8, shadowColor: '#000', shadowOffset: { width: 0, height: -2 },
    shadowOpacity: 0.1, shadowRadius: 6, gap: 10,
  },
  cartButton: {
    flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center',
    backgroundColor: PRODUCT_COLORS.panelAlt, paddingVertical: 14, borderRadius: 14,
    borderWidth: 1.5, borderColor: PRODUCT_COLORS.accent, gap: 8,
  },
  cartButtonText: { fontSize: 15, fontWeight: '700', color: PRODUCT_COLORS.accentSoft, marginLeft: 6 },
  buyButton: {
    flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center',
    backgroundColor: PRODUCT_COLORS.accent, paddingVertical: 14, borderRadius: 14, gap: 8,
  },
