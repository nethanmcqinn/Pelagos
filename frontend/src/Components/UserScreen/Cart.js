  ...
  if (urls.length === 0) {
    return (
      <View style={styles.itemImagePlaceholder}>
        <Icon name="set-meal" size={28} color={CART_COLORS.mutedText} />
      </View>
    );
  }
  ...
  return (
    <View style={styles.cartItem}>
      ...
      <View style={styles.itemInfo}>
        ...
        <View style={styles.qtyRow}>
          <TouchableOpacity
            ...
            activeOpacity={0.7}
          >
            <Icon name="remove" size={16} color={CART_COLORS.accent} />
          </TouchableOpacity>
          ...
          <TouchableOpacity
            ...
            activeOpacity={0.7}
          >
            <Icon name="add" size={16} color={CART_COLORS.accent} />
          </TouchableOpacity>
      ...
      <TouchableOpacity
        ...
        activeOpacity={0.7}
      >
        <Icon name="delete-outline" size={24} color={CART_COLORS.mutedText} />
      </TouchableOpacity>
    </View>
  );
};
      ...
      <SafeAreaView style={styles.safeArea}>
            ...
            <View style={styles.topBarActions}>
              {parseFloat(totalSavings) > 0 && (
                <View style={styles.savingsBadge}>
                  <Icon name="savings" size={16} color={CART_COLORS.success} />
              ...
              <TouchableOpacity
                ...
                activeOpacity={0.7}
              >
                <Icon name="delete-sweep" size={20} color={CART_COLORS.accent} />
        ...
        {cartItems.length === 0 ? (
          <View style={styles.emptyContainer}>
            <Icon name="shopping-cart" size={90} color={CART_COLORS.mutedText} />
          ...
          <>
            <FlatList
              ...
              refreshControl={
                <RefreshControl refreshing={refreshing} onRefresh={onRefresh} colors={[CART_COLORS.accent]} tintColor={CART_COLORS.accent} />
              }
              ListFooterComponent={
...
const styles = StyleSheet.create({
  safeArea: { flex: 1, backgroundColor: CART_COLORS.background },
  centered: { flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: CART_COLORS.background },
  loadingText: { fontSize: 15, color: CART_COLORS.mutedText, marginTop: 12 },
  topBar: {
    flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between',
    paddingHorizontal: 20, paddingTop: 10, paddingBottom: 14,
    backgroundColor: CART_COLORS.panel, borderBottomWidth: 1, borderBottomColor: CART_COLORS.border,
    elevation: 3, shadowColor: '#000', shadowOffset: { width: 0, height: 1 },
    shadowOpacity: 0.2, shadowRadius: 3,
  },
  topBarTitle: { fontSize: 22, fontWeight: '800', color: CART_COLORS.text },
  topBarSubtitle: { fontSize: 13, color: CART_COLORS.mutedText, marginTop: 2 },
  topBarActions: {
    flexDirection: 'row',
    alignItems: 'center',
  },
  ...
  clearBtn: {
    ...
    backgroundColor: CART_COLORS.panelAlt, paddingHorizontal: 12, paddingVertical: 7, borderRadius: 20,
    borderWidth: 1,
    borderColor: CART_COLORS.border,
  },
  clearBtnText: { fontSize: 13, fontWeight: '600', color: CART_COLORS.accentSoft, marginLeft: 5 },
  emptyContainer: { flex: 1, justifyContent: 'center', alignItems: 'center', paddingHorizontal: 30 },
  emptyTitle: { fontSize: 20, fontWeight: '700', color: CART_COLORS.text, marginTop: 16 },
  emptySubtitle: { fontSize: 14, color: CART_COLORS.mutedText, textAlign: 'center', lineHeight: 22, marginTop: 6 },
  shopNowBtn: {
    flexDirection: 'row', alignItems: 'center',
    backgroundColor: CART_COLORS.accent, paddingHorizontal: 24, paddingVertical: 13,
  ...
  cartItem: {
    flexDirection: 'row', backgroundColor: CART_COLORS.panel, borderRadius: 14,
  ...
  itemImageBox: {
    ...
    overflow: 'hidden', backgroundColor: CART_COLORS.panelAlt, marginRight: 12,
  },
  ...
  itemImagePlaceholder: {
    flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: CART_COLORS.panelAlt,
  },
  carouselArrowLeft: {
  ...
  carouselDotActive: { backgroundColor: CART_COLORS.accent, width: 6, height: 6, borderRadius: 3 },
  itemInfo: { flex: 1 },
  itemName: { fontSize: 14, fontWeight: '700', color: CART_COLORS.text, marginBottom: 3, lineHeight: 20 },
  priceContainer: {
    flexDirection: 'row',
    alignItems: 'center',
    flexWrap: 'wrap',
  ...
  itemPrice: { fontSize: 15, fontWeight: '800', color: CART_COLORS.accentSoft },
  discountedPrice: {
    color: CART_COLORS.accentSoft,
  },
  originalPrice: {
    fontSize: 12,
    color: CART_COLORS.mutedText,
  ...
  qtyBtn: {
    ...
    backgroundColor: CART_COLORS.panelAlt, borderWidth: 1, borderColor: CART_COLORS.border,
    justifyContent: 'center', alignItems: 'center',
  },
  qtyBtnDisabled: { opacity: 0.4 },
  qtyText: { fontSize: 15, fontWeight: '700', color: CART_COLORS.text, minWidth: 26, textAlign: 'center' },
  subtotalText: { fontSize: 12, color: CART_COLORS.mutedText, marginLeft: 6 },
  removeBtn: { padding: 6, marginLeft: 4 },
  summaryCard: {
    backgroundColor: CART_COLORS.panel, borderRadius: 16, padding: 18, marginTop: 4,
    elevation: 2, shadowColor: '#000', shadowOffset: { width: 0, height: 1 },
    shadowOpacity: 0.2, shadowRadius: 4,
  },
  summaryTitle: { fontSize: 16, fontWeight: '800', color: CART_COLORS.text, marginBottom: 14 },
  summaryRow: { 
    flexDirection: 'row', 
  ...
  summaryItemPrice: { fontSize: 13, fontWeight: '600', color: CART_COLORS.accentSoft },
  savingsRow: {
    flexDirection: 'row',
    alignItems: 'center',
    backgroundColor: '#173c3b',
  ...
  summaryDivider: { height: 1, backgroundColor: CART_COLORS.border, marginVertical: 12 },
  summaryTotalRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  summaryTotalLabel: { fontSize: 16, fontWeight: '700', color: CART_COLORS.text },
  summaryTotalValue: { fontSize: 22, fontWeight: '900', color: CART_COLORS.accentSoft },
  checkoutBar: {
    position: 'absolute', bottom: 0, left: 0, right: 0,
    flexDirection: 'row', alignItems: 'center',
    paddingHorizontal: 16, paddingVertical: 14, paddingBottom: 22,
    backgroundColor: CART_COLORS.panel, borderTopWidth: 1, borderTopColor: CART_COLORS.border,
    elevation: 10, shadowColor: '#000', shadowOffset: { width: 0, height: -2 },
    shadowOpacity: 0.24, shadowRadius: 6, gap: 12,
  },
  checkoutTotalBox: { flex: 1 },
  checkoutTotalLabel: { fontSize: 12, color: CART_COLORS.mutedText, fontWeight: '500' },
  checkoutTotalValue: { fontSize: 20, fontWeight: '900', color: CART_COLORS.text },
  checkoutBtn: {
    flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center',
    backgroundColor: CART_COLORS.accent, paddingVertical: 15, borderRadius: 14, gap: 8,
  },
