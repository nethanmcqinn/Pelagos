  ...
  if (!validImages || urls.length === 0) {
    return (
      <TouchableOpacity onPress={onImagePress} style={styles.noImageContainer} activeOpacity={0.7}>
        <Icon name="set-meal" size={40} color={CHECKOUT_COLORS.mutedText} />
      </TouchableOpacity>
    );
  }
      ...
      <View style={styles.orderItemDetails}>
        ...
        <View style={styles.quantityRow}>
          ...
          <TouchableOpacity
            ...
            disabled={disabled}
          >
            <Icon name="remove" size={18} color="#1f5ea6" />
          </TouchableOpacity>
          ...
          <TouchableOpacity
            ...
            disabled={disabled}
          >
            <Icon name="add" size={18} color="#1f5ea6" />
          </TouchableOpacity>
        </View>
      </View>
...
export default function Checkout({ route, navigation }) {
  ...
  if (orderItems.length === 0) {
    return (
      <UserDrawer>
        <View style={styles.centered}>
          <Icon name="shopping-cart" size={80} color={CHECKOUT_COLORS.mutedText} />
        ...
        >
          ...
          >
            ...
            <View style={styles.header}>
              ...
              >
                <Icon name="arrow-back" size={24} color="#e6f0ff" />
              </TouchableOpacity>
            ...
            <View style={styles.section}>
              ...
              <View style={styles.infoBox}>
                <View style={styles.infoRow}>
                  <Icon name="location-on" size={20} color="#1f5ea6" />
                ...
                <View style={styles.infoRow}>
                  <Icon name="map" size={20} color="#1f5ea6" />
                ...
                <View style={styles.infoRow}>
                  <Icon name="location-city" size={20} color="#1f5ea6" />
                ...
                <View style={styles.infoRow}>
                  <Icon name="markunread-mailbox" size={20} color="#1f5ea6" />
                ...
                <View style={styles.infoRow}>
                  <Icon name="phone" size={20} color="#1f5ea6" />
              ...
              <TouchableOpacity
                ...
                onPress={() => navigation.navigate('Profile')}
              >
                <Icon name="edit" size={18} color="#1f5ea6" />
...
const styles = StyleSheet.create({
  ...
  loadingText: { 
    fontSize: 15, 
    color: CHECKOUT_COLORS.mutedText, 
    marginTop: 12 
  },
  emptyText: {
    fontSize: 18,
  ...
  header: {
    ...
    paddingVertical: 12,
    backgroundColor: CHECKOUT_COLORS.panel,
    borderBottomWidth: 1,
    borderBottomColor: CHECKOUT_COLORS.border,
  },
  backButton: {
    width: 40,
    height: 40,
  ...
  orderItem: {
    flexDirection: 'row',
    backgroundColor: CHECKOUT_COLORS.panelAlt,
    borderRadius: 10,
    marginBottom: 10,
    padding: 10,
    borderWidth: 1,
  ...
  orderItemPrice: {
    fontSize: 14,
    fontWeight: '700',
    color: CHECKOUT_COLORS.accentSoft,
  },
  originalPrice: {
    fontSize: 12,
    color: CHECKOUT_COLORS.mutedText,
  ...
  qtyBtn: {
    ...
    backgroundColor: CHECKOUT_COLORS.panel,
    borderWidth: 1,
    borderColor: CHECKOUT_COLORS.accent,
    justifyContent: 'center',
    alignItems: 'center',
  },
  qtyBtnDisabled: {
