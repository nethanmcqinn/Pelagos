// CVPetShop/frontend/src/Components/UserScreen/Notification/OrderNotification.js
        ...
        <View style={styles.notificationContent}>
          ...
          {data?.orderId && (
            <View style={styles.orderIdContainer}>
              <Icon name="shopping-bag" size={12} color="#9ab4d3" />
  ...
  const renderEmptyState = () => (
    <View style={styles.emptyState}>
      ...
      <Text style={styles.emptyStateSubtext}>
        You'll receive notifications here when your order status changes
      </Text>
