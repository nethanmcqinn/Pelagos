    ...
    >
      ...
      <View style={styles.header}>
        <TouchableOpacity
          ...
          hitSlop={{ top: 10, bottom: 10, left: 10, right: 10 }}
        >
          <Ionicons name="arrow-back" size={24} color="#e6f0ff" />
        </TouchableOpacity>
      ...
      <View style={styles.infoCard}>
        <Ionicons name="information-circle-outline" size={24} color="#1f5ea6" />
      ...
      <View style={styles.requirementsCard}>
        ...
        <View style={styles.requirementItem}>
          <Ionicons 
            ...
            size={18} 
            color={formData.newPassword.length >= 8 ? "#4CAF50" : "#8da9c4"} 
          />
        ...
        <View style={styles.requirementItem}>
          <Ionicons 
            ...
            size={18} 
            color={/[A-Z]/.test(formData.newPassword) ? "#4CAF50" : "#8da9c4"} 
          />
        ...
        <View style={styles.requirementItem}>
          <Ionicons 
            ...
            size={18} 
            color={/\d/.test(formData.newPassword) ? "#4CAF50" : "#8da9c4"} 
          />
        ...
        {formData.newPassword && formData.confirmPassword && (
          <View style={styles.matchIndicator}>
            <Ionicons 
              ...
              size={20} 
              color={formData.newPassword === formData.confirmPassword ? "#4CAF50" : "#1f5ea6"} 
            />
            <Text style={[
              styles.matchText,
              { color: formData.newPassword === formData.confirmPassword ? "#4CAF50" : "#1f5ea6" }
      ...
      <View style={styles.securityNote}>
        <Ionicons name="shield-checkmark-outline" size={16} color="#8da9c4" />
