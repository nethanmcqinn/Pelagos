// CVPetShop/frontend/src/Components/AdminScreen/reviewmanagement/ReviewList.js
...
export default function ReviewListScreen({ navigation }) {
  ...
  const fetchReviews = async () => {
    try {
      ...
      // Get all active reviews - matches your route: /api/v1/admin/reviews
      ...
      >
        <View style={styles.reviewHeader}>
          <View style={styles.productInfo}>
            <Icon name="shopping-bag" size={20} color="#1f5ea6" />
        ...
        <View style={styles.reviewFooter}>
          <Icon name="chevron-right" size={20} color="#9ab4d3" />
        </View>
      </TouchableOpacity>
    </Swipeable>
  );
  ...
  const ReviewListContent = () => (
    <View style={styles.container}>
      ...
      <View style={styles.searchContainer}>
        <Icon name="search" size={20} color="#9ab4d3" style={styles.searchIcon} />
        <TextInput
        ...
        {searchQuery.length > 0 && (
          <TouchableOpacity onPress={() => setSearchQuery('')}>
            <Icon name="close" size={20} color="#9ab4d3" />
          </TouchableOpacity>
        )}
      </View>
      ...
      >
        <Icon name="filter-list" size={20} color="#1f5ea6" />
