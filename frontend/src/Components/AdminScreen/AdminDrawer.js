...
const AdminDrawer = ({ children, onLogout }) => {
  ...
  const menuItems = [
    ...
    { name: 'Category', icon: 'shape', screen: 'Category' },
  ];
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        >
          <Icon name="menu" size={30} color="#e6f0ff" />
        </TouchableOpacity>
      ...
      {isDrawerOpen && (
        ...
        >
          <View style={styles.drawerHeader}>
            <Icon name="fish" size={40} color="#1f5ea6" />
            <Text style={styles.drawerHeaderText}>PELAGOS</Text>
            ...
            {menuItems.map((item) => (
              ...
              >
                <Icon
                  name={item.icon}
                  size={24}
                  color={selectedItem === item.name ? '#1f5ea6' : '#9ab4d3'}
                />
                <Text
                  style={[
          ...
          <View style={styles.drawerFooter}>
            <TouchableOpacity 
              ...
              activeOpacity={0.7}
            >
              <Icon name="cog" size={20} color="#9ab4d3" />
            ...
            <TouchableOpacity 
              ...
              activeOpacity={0.7}
            >
              <Icon name="logout" size={20} color="#9ab4d3" />
