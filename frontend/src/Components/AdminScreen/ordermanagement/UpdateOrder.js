// CVPetShop/frontend/src/Components/AdminScreen/ordermanagement/UpdateOrder.js
      ...
      <ScrollView style={styles.container}>
        ...
        <View style={styles.orderInfoCard}>
          ...
          <View style={styles.infoRow}>
            <Icon name="person" size={16} color="#9ab4d3" />
            <Text style={styles.infoText}>{order.user?.name || 'N/A'}</Text>
          </View>
          <View style={styles.infoRow}>
            <Icon name="attach-money" size={16} color="#9ab4d3" />
              ...
              <View style={styles.modalContent}>
                <View style={styles.modalHeader}>
                  ...
                  <TouchableOpacity onPress={() => setDropdownVisible(false)}>
                    <Icon name="close" size={24} color="#9ab4d3" />
                  </TouchableOpacity>
                </View>
                <FlatList
                  data={ORDER_STATUSES}
