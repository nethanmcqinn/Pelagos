// CVPetShop/frontend/src/Components/AdminScreen/ordermanagement/ViewOrder.js
...
export default function ViewOrderScreen({ route, navigation }) {
  ...
  const fetchOrderDetails = async () => {
    try {
      ...
      const res = await axios.get(`${BACKEND_URL}/api/v1/admin/orders/${orderId}`, {
    ...
    <AdminDrawer onLogout={handleLogout}>
      <ScrollView style={styles.container}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.infoGrid}>
            <View style={styles.infoItem}>
              <Icon name="receipt" size={20} color="#9ab4d3" />
            ...
            <View style={styles.infoItem}>
              <Icon name="event" size={20} color="#9ab4d3" />
              <View style={styles.infoContent}>
            ...
            <View style={styles.infoItem}>
              <Icon name="payment" size={20} color="#9ab4d3" />
              <View style={styles.infoContent}>
            ...
            {order.paymentInfo?.status && (
              <View style={styles.infoItem}>
                <Icon name="check-circle" size={20} color="#9ab4d3" />
                <View style={styles.infoContent}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.infoGrid}>
            <View style={styles.infoItem}>
              <Icon name="person" size={20} color="#9ab4d3" />
              <View style={styles.infoContent}>
            ...
            <View style={styles.infoItem}>
              <Icon name="email" size={20} color="#9ab4d3" />
              <View style={styles.infoContent}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.addressContainer}>
            <Icon name="location-on" size={20} color="#9ab4d3" />
          ...
          <View style={styles.contactContainer}>
            <Icon name="phone" size={20} color="#9ab4d3" />
